...
projects[thacker][download][url] = https://barraponto@github.com/barraponto/thacker-thacker-theme.git
projects[] = skinr

;thacker_project feature and dependencies
projects[thacker_project][type] = module
projects[thacker_project][download][type] = git
projects[thacker_project][download][url] = https://barraponto@github.com/barraponto/thacker-project-feature.git
projects[] = og
projects[] = link 
...
projects[thacker_profile][download][url] = https://barraponto@github.com/barraponto/thacker-profile-feature.git
...
projects[thacker_page][download][url] = https://barraponto@github.com/barraponto/thacker-page-feature.git

;thacker_event feature and dependencies
projects[thacker_event][type] = module
projects[thacker_event][download][type] = git
projects[thacker_event][download][url] = https://barraponto@github.com/barraponto/thacker-event-feature.git
projects[] = signup
...
projects[thacker_heartbeat][download][url] = https://barraponto@github.com/barraponto/thacker-heartbeat-feature.git
projects[] = heartbeat
projects[] = rules
...
projects[thacker_distro][download][url] = https://barraponto@github.com/barraponto/thacker-distro-feature.git
